class CraftFullUtopiaGraphicsCard4090TI extends RecipeBase
{
    override void Init()
    {
        m_Name = "Repair Utopia Graphics Card 4090TI";  // Name of the crafting recipe
        ...
        // Conditions for Ingredient 1: Utopia_Graphics_Card_4090TI (damaged card)
        ...
        // Ingredient 1: Utopia_Graphics_Card_4090TI
        InsertIngredient(0, "Utopia_Graphics_Card_4090TI");
        ...
        // Result: Utopia_Graphics_Card_4090TI (repaired)
        AddResult("Utopia_Graphics_Card_4090TI");
    ...
    {
        Debug.Log("CraftFullUtopiaGraphicsCard4090TI Recipe Do method called", "recipes");
    }
};
