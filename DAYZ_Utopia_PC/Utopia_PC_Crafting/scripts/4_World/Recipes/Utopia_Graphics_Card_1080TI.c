class CraftFullUtopiaGraphicsCard1080TI extends RecipeBase
{
    override void Init()
    {
        m_Name = "Repair Utopia Graphics Card 1080TI";  // Name of the crafting recipe
        ...
        // Conditions for Ingredient 1: Utopia_Graphics_Card_1080TI (damaged card)
        ...
        // Ingredient 1: Utopia_Graphics_Card_1080TI
        InsertIngredient(0, "Utopia_Graphics_Card_1080TI");
        ...
        // Result: Utopia_Graphics_Card_1080TI (repaired)
        AddResult("Utopia_Graphics_Card_1080TI");
    ...
    {
        Debug.Log("CraftFullUtopiaGraphicsCard1080TI Recipe Do method called", "recipes");
    }
};
